  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Fillipe Augusto - Your reliable partner in managing projects with precision, efficiency, and ease. Streamline your tasks, optimize your time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Fillipe Augusto - Your reliable partner in managing projects with precision, efficiency, and ease. Streamline your tasks, optimize your time.`}
            </Text>
            <Box
